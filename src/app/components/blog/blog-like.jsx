...
const BlogLike = ({ data, login }) => {
    ...
    // いいねボタンクリック
    const commentLike = async (comment_id, handle) => {
    ...
    const renderLike = data => {
        ...
        if (login) {
            ...
            if (loadingLike == data.id) {
                // ローディング
                return (
                    <div className="h-4 w-4 animate-spin rounded-full border border-main-orange border-t-transparent" />
                )
